<footer>
        ...
        <div class="footer-content">
            ...
            <div class="footer-section footer-contacts">
                ...
                <div class="contact-item">
                    <svg class="contact-icon-svg" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-info">
                        <a href="tel:+919207973906" class="contact-link">+91 9207973906</a>
                    </div>
                </div>
                <div class="contact-item">
                    <svg class="contact-icon-svg" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div class="contact-info">
                        <a href="mailto:invenzalifesciences@gmail.com" class="contact-link">invenzalifesciences@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <p>&copy; <?php echo date('Y'); ?> Invenza. All rights reserved.</p>
    </div>
